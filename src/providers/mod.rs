...
pub static PROVIDERS: &[ProviderMeta] = &[
    ...
    ProviderMeta { slug: "alviy", name: "Alviy", env_vars: &["ALVIY_Key", "ALVIY_Secret"], create: |env| alviy::Alviy::new(env) },
    ProviderMeta { slug: "anikeen", name: "Anikeen", env_vars: &["ANIKEEN_USERNAME", "ANIKEEN_PASSWORD"], create: |env| anikeen::Anikeen::new(env) },
    ProviderMeta { slug: "anx", name: "Anx", env_vars: &["ANEXIA_Token"], create: |env| anx::Anx::new(env) },
    ProviderMeta { slug: "area7", name: "Area7", env_vars: &["AREA7_API_KEY"], create: |env| area7::Area7::new(env) },
    ProviderMeta { slug: "artfiles", name: "Artfiles", env_vars: &["ARTFILES_Key", "ARTFILES_Secret"], create: |env| artfiles::Artfiles::new(env) },
    ...
    ProviderMeta { slug: "czechia", name: "Czechia", env_vars: &["CZECHIA_API_KEY"], create: |env| czechia::Czechia::new(env) },
    ProviderMeta { slug: "da", name: "Da", env_vars: &["DA_Api", "DA_Api_Insecure"], create: |env| da::Da::new(env) },
    ProviderMeta { slug: "ddnss", name: "Ddnss", env_vars: &["DDNSS_Key", "DDNSS_Secret"], create: |env| ddnss::Ddnss::new(env) },
    ...
    ProviderMeta { slug: "dnsexit", name: "Dnsexit", env_vars: &["DNSEXIT_API_KEY", "DNSEXIT_API_Key"], create: |env| dnsexit::Dnsexit::new(env) },
    ...
    ProviderMeta { slug: "efficientip", name: "Efficientip", env_vars: &["EFFICIENTIP_USERNAME", "EFFICIENTIP_PASSWORD", "EFFICIENTIP_HOSTNAME"], create: |env| efficientip::Efficientip::new(env) },
    ...
    ProviderMeta { slug: "exoscale", name: "Exoscale", env_vars: &["EXOSCALE_API_KEY", "EXOSCALE_API_SECRET", "EXOSCALE_ORG"], create: |env| exoscale::Exoscale::new(env) },
    ProviderMeta { slug: "firestorm", name: "Firestorm", env_vars: &["FIRESTORM_Key"], create: |env| firestorm::Firestorm::new(env) },
    ProviderMeta { slug: "fornex", name: "Fornex", env_vars: &["FORNEX_Username", "FORNEX_Password"], create: |env| fornex::Fornex::new(env) },
    ...
    ProviderMeta { slug: "gname", name: "Gname", env_vars: &["GNAME_USERNAME", "GNAME_PASSWORD"], create: |env| gname::Gname::new(env) },
    ...
    ProviderMeta { slug: "hetznercloud", name: "Hetznercloud", env_vars: &["HETZNERCLOUD_Token"], create: |env| hetznercloud::Hetznercloud::new(env) },
    ProviderMeta { slug: "hexonet", name: "Hexonet", env_vars: &["HEXONET_User", "HEXONET_Password"], create: |env| hexonet::Hexonet::new(env) },
    ProviderMeta { slug: "hosting1984", name: "Hosting1984", env_vars: &["FOURTH1984_USERNAME", "FOURTH1984_PASSWORD"], create: |env| hosting1984::Hosting1984::new(env) },
    ...
    ProviderMeta { slug: "hostup", name: "Hostup", env_vars: &["HOSTUP_Username", "HOSTUP_Password"], create: |env| hostup::Hostup::new(env) },
    ProviderMeta { slug: "huaweicloud", name: "Huaweicloud", env_vars: &["HUAWEICLOUD_AccessKeyID", "HUAWEICLOUD_SecretAccessKey", "HUAWEICLOUD_Region"], create: |env| huaweicloud::Huaweicloud::new(env) },
    ProviderMeta { slug: "infoblox", name: "Infoblox", env_vars: &["Infoblox_Creds", "Infoblox_Server"], create: |env| infoblox::Infoblox::new(env) },
    ProviderMeta { slug: "infoblox_uddi", name: "InfobloxUddi", env_vars: &["INFOBLOX_UDDI_CREDENTIALS", "INFOBLOX_UDDI_SERVER"], create: |env| infoblox_uddi::InfobloxUddi::new(env) },
    ...
    ProviderMeta { slug: "ipprojects", name: "Ipprojects", env_vars: &["IPPROJECTS_Key", "IPPROJECTS_Secret"], create: |env| ipprojects::Ipprojects::new(env) },
    ProviderMeta { slug: "ipv64", name: "Ipv64", env_vars: &["IPV64_API_KEY"], create: |env| ipv64::Ipv64::new(env) },
    ...
    ProviderMeta { slug: "jd", name: "Jd", env_vars: &["JD_ACCESS_KEY", "JD_SECRET_KEY", "JD_REGION"], create: |env| jd::Jd::new(env) },
    ProviderMeta { slug: "joker", name: "Joker", env_vars: &["JOKER_USERNAME", "JOKER_PASSWORD"], create: |env| joker::Joker::new(env) },
    ProviderMeta { slug: "kappernet", name: "Kappernet", env_vars: &["KAPPERNET_Username", "KAPPERNET_Password"], create: |env| kappernet::Kappernet::new(env) },
    ...
    ProviderMeta { slug: "limacity", name: "Limacity", env_vars: &["LIMACITY_API_KEY"], create: |env| limacity::Limacity::new(env) },
    ...
    ProviderMeta { slug: "mgwm", name: "Mgwm", env_vars: &["MGWM_USERNAME", "MGWM_PASSWORD"], create: |env| mgwm::Mgwm::new(env) },
    ...
    ProviderMeta { slug: "nederhost", name: "Nederhost", env_vars: &["NEDERHOST_Key", "NEDERHOST_Secret"], create: |env| nederhost::Nederhost::new(env) },
    ProviderMeta { slug: "neodigit", name: "Neodigit", env_vars: &["NEODIGIT_Key", "NEODIGIT_Secret"], create: |env| neodigit::Neodigit::new(env) },
    ...
    ProviderMeta { slug: "nm", name: "Nm", env_vars: &["NM_Username", "NM_Password"], create: |env| nm::Nm::new(env) },
    ...
    ProviderMeta { slug: "nw", name: "Nw", env_vars: &["NW_API_TOKEN"], create: |env| nw::Nw::new(env) },
    ProviderMeta { slug: "oci", name: "Oci", env_vars: &["OCI_PRIVKEY", "OCI_TENANCY", "OCI_USER", "OCI_REGION", "OCI_COMPARTMENT"], create: |env| oci::Oci::new(env) },
    ProviderMeta { slug: "omglol", name: "Omglol", env_vars: &["OMGLOL_Key", "OMGLOL_Secret"], create: |env| omglol::Omglol::new(env) },
    ...
    ProviderMeta { slug: "openstack", name: "Openstack", env_vars: &["OS_AUTH_URL", "OS_USERNAME", "OS_PASSWORD", "OS_PROJECT_NAME"], create: |env| openstack::Openstack::new(env) },
    ...
    ProviderMeta { slug: "opusdns", name: "Opusdns", env_vars: &["OPUSDNS_Key", "OPUSDNS_Secret"], create: |env| opusdns::Opusdns::new(env) },
    ...
    ProviderMeta { slug: "pointhq", name: "Pointhq", env_vars: &["POINTHQ_User", "POINTHQ_Token"], create: |env| pointhq::Pointhq::new(env) },
    ...
    ProviderMeta { slug: "poweradmin", name: "Poweradmin", env_vars: &["POWERADMIN_Username", "POWERADMIN_Password", "POWERADMIN_Hostname"], create: |env| poweradmin::Poweradmin::new(env) },
    ProviderMeta { slug: "qc", name: "Qc", env_vars: &["QC_API_KEY", "QC_API_SECRET"], create: |env| qc::Qc::new(env) },
    ProviderMeta { slug: "rackcorp", name: "Rackcorp", env_vars: &["RACKCORP_UUID", "RACKCORP_API_KEY"], create: |env| rackcorp::Rackcorp::new(env) },
    ...
    ProviderMeta { slug: "rcode0", name: "Rcode0", env_vars: &["RCODE0_Token"], create: |env| rcode0::Rcode0::new(env) },
    ...
    ProviderMeta { slug: "variomedia", name: "Variomedia", env_vars: &["VARIOMEDIA_Email", "VARIOMEDIA_Token"], create: |env| variomedia::Variomedia::new(env) },
    ProviderMeta { slug: "veesp", name: "Veesp", env_vars: &["VEESP_Username", "VEESP_Password"], create: |env| veesp::Veesp::new(env) },
    ProviderMeta { slug: "vercel", name: "Vercel", env_vars: &["VERCEL_TOKEN"], create: |env| vercel::Vercel::new(env) },
    ProviderMeta { slug: "virakcloud", name: "Virakcloud", env_vars: &["VIRAKCLOUD_Token"], create: |env| virakcloud::Virakcloud::new(env) },
    ...
    ProviderMeta { slug: "websupport", name: "Websupport", env_vars: &["WEBSUPPORT_Key", "WEBSUPPORT_Secret"], create: |env| websupport::Websupport::new(env) },
    ProviderMeta { slug: "wedos", name: "Wedos", env_vars: &["WEDOS_User", "WEDOS_Password"], create: |env| wedos::Wedos::new(env) },
    ProviderMeta { slug: "west_cn", name: "WestCn", env_vars: &["WEST_CN_Username", "WEST_CN_Password"], create: |env| west_cn::WestCn::new(env) },
    ...
    ProviderMeta { slug: "zilore", name: "Zilore", env_vars: &["ZILORE_Key", "ZILORE_Secret"], create: |env| zilore::Zilore::new(env) },
    ProviderMeta { slug: "zone", name: "Zone", env_vars: &["ZONE_Username", "ZONE_Key"], create: |env| zone::Zone::new(env) },
    ProviderMeta { slug: "zoneedit", name: "Zoneedit", env_vars: &["ZONEEDIT_User", "ZONEEDIT_Token"], create: |env| zoneedit::Zoneedit::new(env) },
    ProviderMeta { slug: "zonomi", name: "Zonomi", env_vars: &["ZONOMI_Api_Key"], create: |env| zonomi::Zonomi::new(env) },
];
